...
for iter = 1:800
    ...
    for i=1:nCirc
        ...
        r = circObs(i,3)+1.2;
        rectangle('Position',[circObs(i,1)-r, circObs(i,2)-r, 2*r, 2*r],'Curvature',[1 1], 'EdgeColor',[0.5 0.3 0.7], 'LineStyle','--', 'LineWidth',1.5);
        % Danger zone
        r = repRange;
        rectangle('Position',[circObs(i,1)-r, circObs(i,2)-r, 2*r, 2*r], 'Curvature',[1 1], 'EdgeColor',[1 0.8 0], 'LineStyle',':', 'LineWidth',1.2);
    end
    % Path trace
